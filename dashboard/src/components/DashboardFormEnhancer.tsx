...
function actionText(action: string) {
  ...
  if (action.includes("/api/admin/discord/nicknames/cleanup")) return { label: "Знімаємо...", title: "Знімаємо ролі за неправильний серверний нік", message: "Перевіряємо серверні ніки за шаблоном і знімаємо вибрані ролі з невідповідних учасників." };
