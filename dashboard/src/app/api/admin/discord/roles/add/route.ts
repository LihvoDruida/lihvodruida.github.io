...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    await auditDiscordAdmin("discord.member.roles.add", guard.session, result);
    ...
    return discordAdminError(request, "admin.discord.roles_add_failed", error, "Discord не видав ролі.");
  }
}
