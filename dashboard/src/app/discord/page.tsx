  ...
  return (
    <main className="container">
        ...
        <header className="hero panel dashboard-hero content-dashboard-hero discord-dashboard-hero">
          <div className="hero-copy dashboard-hero__copy content-dashboard-hero__copy">
            ...
            <div className="content-hero-status-row" aria-label="Стан Discord редактора">
              <span className="content-mode-pill content-mode-pill--library">Embed hub</span>
              <span className="content-hero-path">Rules list • Rules editor • General sender</span>
            </div>
            <h1>Discord embeds</h1>
            <span className="hero-accent" aria-hidden="true" />
            <p className="lead">Окремі сторінки для правил і звичайних embed-повідомлень. Правила мають список, редактор, ролі та кнопки прийняття.</p>
            <div className="hero-secure-note content-hero-actions">
              <span className="hero-lock" aria-hidden="true">✦</span>
              <span>Доступ тільки для адміністратора. Бот-токен не віддається у браузер.</span>
            </div>
          </div>
      ...
      {!isAdmin ? (
        ...
        <section className="discord-hub-grid" aria-label="Discord embed розділи">
          <a className="panel discord-hub-card discord-hub-card--rules" href="/discord/rules">
            ...
            <p>Список тільки rule embed-повідомлень, кнопка додавання, редагування, ролі для “Прийняти”.</p>
            <span className="btn primary">Відкрити правила</span>
          </a>

          <a className="panel discord-hub-card" href="/discord/embed">
            <span className="eyebrow">General embed</span>
            <strong>Звичайна відправка</strong>
            <p>Окрема сторінка для публікації embed у будь-який канал або редагування за посиланням.</p>
            <span className="btn subtle">Відкрити embed sender</span>
          </a>
        </section>
      )}
    </main>
