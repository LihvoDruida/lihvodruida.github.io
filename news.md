...
<div class="area-content listing-page listing-page--news">
  ...
  {% if news_list.size == 0 %}
    <div class="empty-state-wow empty-state-wow--listing">
      ...
      <p>У цьому розділі ще немає опублікованих матеріалів. Це нормальний порожній стан: коли з’явиться перша новина, вона автоматично стане головною карткою тут.</p>
